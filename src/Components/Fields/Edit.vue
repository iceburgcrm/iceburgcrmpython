<template>
    <div class="grid grid-auto grid-flow-row">
        ...
        <div v-if="props.field.input_type === 'tel'" class="rounded">
            <input size="35" placeholder="+1 (999) 999-9999" :name="current_field.module_id + '_' + current_field.name" type="text" class="input-secondary rounded sm:text-sm sm:leading-5" v-model="display_value" />
        </div>
        ...
        <div v-else-if="props.field.input_type === 'zip'" class="">
            <input size="35" placeholder="" :name="current_field.module_id + '_' + current_field.name" type="text" class="input-secondary rounded sm:text-sm sm:leading-5" v-model="display_value" />
        </div>
...
if(props.field !==  null && props.field !== undefined && props.field.module !== undefined) {
