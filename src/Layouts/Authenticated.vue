    ...
    <div>
        ...
        <div class="navbar bg-primary text-primary-content">
            ...
            <div class="navbar-end">
                <a class="mr-2" href="/calendar" v-if="props.auth.meetings">
                ...
                <BreezeDropdown align="right" width="48">
                    ...
                    <template #content>
                        <div class="grid grid-flow-row p-5 bg-base-100 gp-5">
                            <ul>
                                <li>
                                    <a class="font-medium  hover:text-accent text-base-content grid-row-1" href="/auth/logout" method="post" as="button">
                                        Log Out
                                    </a>
                                </li>
                                <li>
                                    <a class="font-medium  hover:text-accent text-base-content grid-row-1" href="/import" method="post" as="button">
                                        Import
                                    </a>
                                </li>
                                <li v-if="$page.props.auth.user.role.name === 'Admin'"><hr class="mt-3 mb-3" /></li>

                                <li v-if="$page.props.auth.user.role.name === 'Admin'">
                                    <a class="font-medium  hover:text-accent text-base-content grid-row-1" href="/settings" method="get" as="button">
                                        Settings
                                    </a>
                                </li>
                                <li v-if="$page.props.auth.user.role.name === 'Admin'">
                                ...
                                <li v-if="$page.props.auth.user.role.name === 'Admin'">
                                    <a class="font-medium hover:text-accent text-base-content grid-row-1" href="/admin/data" method="get" as="button">
                                        Data
                                    </a>
                                </li>
                                <li v-if="$page.props.auth.user.role.name === 'Admin'">
                                    <a class="font-medium hover:text-accent text-base-content grid-row-1" href="/admin/connectors" method="get" as="button">
                                        Connectors
                                    </a>
                                </li>
                                <li v-if="$page.props.auth.user.role.name === 'Admin'">
                                    <a class="font-medium hover:text-accent text-base-content grid-row-1" href="/admin/scheduler" method="get" as="button">
                                        Scheduler
                                    </a>
                                </li>
                                <li v-if="$page.props.auth.user.role.name === 'Admin'">
                                    <a class="font-bold mt-3   hover:text-accent text-base-content grid-row-1" href="/admin/builder" method="get" as="button">
                                        Builder
                                    </a>
                                </li>
                                <li v-if="$page.props.auth.user.role.name === 'Admin'">
