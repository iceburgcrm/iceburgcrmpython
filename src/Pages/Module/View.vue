<template>
    ...
    <BreadCrumbs :levels="$page.props.breadcrumbs" />
                            ...
                            <div class="card shadow-xl bg-base-100"  v-for="field in $page.props.fields">
                                <div class="card-body h-100 w-200">
                                    ...
                                    <Display class="font-medium"
                                        ...
                                        v-bind:field_data="$page.props.field[field.name]"
                                    />
                                </div>
                            </div>
                        </div>
        ...
        <div v-if="props.workflow.length > 0" class="pt-5 pb-5 max-w-full sm:px-3 lg:px-4 bg-base-200 text-base-content rounded  shadow-sm m-5" >
                    ...
                    <div class="grid grid-flow-row">
                        <div class="align-center">
                            <ul class="steps steps-vertical w-full">
                                <li :class="item.className" v-for="item in props.workflow">
        ...
        <div class="max-w-full grid col-auto">
            <div class="p-5" v-for="subpanel_id in props.subpanel_ids">
                <Subpanel
                    :record_id="$page.props.record.id"
                    :module_id="$page.props.module.id"
                    v-bind:id="subpanel_id.id"
                    :permissions="$page.props.permissions"
                    :auth="props.auth"
                />
            </div>
...
const props = defineProps({
   ...
   next: [Object, Array, null],
   previous: [Object, Array, null],
   workflow: [Object, Array, null],
   field: [Object, Array, null],
   subpanel_ids: [Object, Array, null],
   subpanels: [Object, Array, null],
