                        ...
                        <div class="container flex mx-auto">
                            <div class="flex border-2 rounded">
                                ...
                                <select class=" text-sm" v-model="search_field">
                                    ...
                                    <option v-for="field in subpanelfields" :value="field.field.module.id + '__' + field.field.name">{{field.field.label}}</option>
                                </select>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table table-zebra w-full border-separate">
                            ...
                            <tr>
                                ...
                                <th v-for="field in subpanelfields">
                                    {{field.field.module.name}}.{{field.field.label ? field.field.label : field.field.label}}
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="(value, index2) in data">
                                ...
                                <td class="hover" v-for="(field, index) in subpanelfields">
                                    <Display
...
const per_page = ref(props.auth.system_settings.submodule_search_per_page);
...
const get_subpanel_data = function (){
    ...
    axios.get(`/data/subpanel/${props.id}?`+ Object.keys(options).map(key => key + '=' + options[key])
        ...
        .then(response => {
            ...
            relationship_id.value=response.data.relationship.id;
